  ...
  return (
    <>
      ...
      <div className="w-full bg-white flex flex-col items-center pt-10 pb-20">
        <div className="w-full max-w-[1240px] px-4 lg:px-0">
          ...
          {items.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-20 bg-[#F9F1E7] rounded-lg mb-16 mx-4 lg:mx-0">
              <p className="font-poppins text-xl text-[#333333] mb-6">
                Your cart is empty
              </p>
              <Link to="/shop">
            ...
            <div className="flex flex-col lg:flex-row gap-8">
              <div className="flex flex-col gap-4 lg:hidden w-full">
                {items.map((item) => {
                  ...
                  return (
                    <div
                      key={item.id}
                      className="flex gap-4 items-center bg-white border border-[#F9F1E7] p-4 rounded-lg shadow-sm"
                    >
                      <img
                        src={item.image}
                        alt={item.name}
                  ...
                  <tbody className="font-poppins text-[16px] text-[#9F9F9F]">
                    {items.map((item) => {
                      ...
                      return (
                        <tr
                          key={item.id}
                          className="border-b border-[#F9F1E7] last:border-none hover:bg-gray-50 transition-colors"
                        >
              ...
              <div className="w-full lg:w-[393px] bg-[#F9F1E7] px-6 lg:px-[75px] py-8 lg:pt-[15px] lg:pb-[80px] flex flex-col items-center rounded-lg lg:rounded-none h-fit">
                ...
                <div className="w-full flex justify-between mb-4 lg:mb-6 items-center">
                  <span className="font-poppins font-medium text-[16px] text-[#000000]">
                    Subtotal
                  </span>
                ...
                <Link
                  to="/checkout"
                  className="w-full max-w-[222px] py-[14px] border border-[#000000] rounded-[15px] font-poppins text-[18px] lg:text-[20px] text-[#000000] hover:bg-[#000000] hover:text-white transition-colors flex items-center justify-center cursor-pointer"
                >
                  Check Out
                </Link>
              </div>
        ...
        <div className="w-full mt-20 lg:mt-[85px]">
          <FeaturesSection />
        </div>
